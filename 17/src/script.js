...
const tick = () =>
{
    ...
    ghost1.position.x = Math.cos(angle1) * 4
    ...
    ghost2.position.y = Math.sin(elapsedTime) * 6 + 3

    const angle3 = elapsedTime * 0.32
    ghost3.position.x = Math.cos(angle3) * 8
    ghost3.position.z = Math.sin(angle3) * 8
