...
gui.add(waterMaterial.uniforms.uBigWavesElevation, 'value').min(0).max(1).step(0.01).name('uBigWavesElevations')
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'x').min(0).max(10).step(0.01).name('uBigWavesFrequencyX')
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'y').min(0).max(10).step(0.01).name('uBigWavesFrequencyZ')
gui.add(waterMaterial.uniforms.uBigWavesSpeed, 'value').min(0).max(10).step(0.01).name('uBigWavesSpeed')
gui.addColor(debug, 'surfaceColor').onChange(()=>{waterMaterial.uniforms.uSurfaceColor.value.set(debug.surfaceColor)})
gui.addColor(debug, 'depthColor').onChange(()=>{waterMaterial.uniforms.uDepthColor.value.set(debug.depthColor)})
